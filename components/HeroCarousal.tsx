        ...
        <SwiperSlide>
          <div className="flex items-center pt-6 sm:pt-0 flex-col-reverse sm:flex-row bg-gradient-to-r from-[#FFE5F1] to-[#FFF6E5] relative w-full min-h-[500px] md:min-h-[550px]">
            ...
            <div className="w-full sm:w-1/2 max-w-[500px] py-6 sm:py-10 lg:py-16 px-6 sm:pl-8 lg:pl-16 z-10">
              <div className="flex items-center gap-2 sm:gap-4 mb-4 sm:mb-6 lg:mb-8 hover:scale-105 transition-transform duration-300">
              ...
              <a
                href="#"
                className="inline-flex font-medium text-white text-xs sm:text-sm rounded-full bg-[#EF476F] py-2.5 sm:py-3.5 px-6 sm:px-9 mt-6 sm:mt-8 lg:mt-10 shadow-lg hover:bg-[#118AB2] hover:shadow-xl transform hover:-translate-y-1 hover:scale-105 transition-all duration-300"
              >
                Shop Now
              </a>
            </div>
        ...
        <SwiperSlide>
          <div className="flex items-center pt-6 sm:pt-0 flex-col-reverse sm:flex-row bg-gradient-to-r from-[#E0F7FA] to-[#E8F5E9] relative w-full min-h-[500px] md:min-h-[550px]">
            ...
            <div className="w-full sm:w-1/2 max-w-[500px] py-6 sm:py-10 lg:py-16 px-6 sm:pl-8 lg:pl-16 z-10">
              ...
              <p className="text-[#073B4C]/80 text-sm sm:text-base leading-relaxed">
                BPA-free, leak-proof bottles with your child’s name. Choose from unicorns, dinosaurs, space themes, and more!
              </p>
              <a
                href="#"
                className="inline-flex font-medium text-white text-xs sm:text-sm rounded-full bg-[#06D6A0] py-2.5 sm:py-3.5 px-6 sm:px-9 mt-6 sm:mt-8 lg:mt-10 shadow-lg hover:bg-[#118AB2] hover:shadow-xl transform hover:-translate-y-1 hover:scale-105 transition-all duration-300"
              >
                Shop Now
              </a>
            </div>
        ...
        <SwiperSlide>
          <div className="flex items-center pt-6 sm:pt-0 flex-col-reverse sm:flex-row bg-gradient-to-r from-[#E8EAF6] to-[#FFF8E1] relative w-full min-h-[500px] md:min-h-[550px]">
            ...
            <div className="w-full sm:w-1/2 max-w-[500px] py-6 sm:py-10 lg:py-16 px-6 sm:pl-8 lg:pl-16 z-10">
              ...
              <a
                href="#"
                className="inline-flex font-medium text-white text-xs sm:text-sm rounded-full bg-[#118AB2] py-2.5 sm:py-3.5 px-6 sm:px-9 mt-6 sm:mt-8 lg:mt-10 shadow-lg hover:bg-[#EF476F] hover:shadow-xl transform hover:-translate-y-1 hover:scale-105 transition-all duration-300"
              >
                Shop Now
              </a>
            </div>
            ...
            <div className="w-full sm:w-1/2 flex justify-center sm:justify-end items-center">
              <div className="relative">
                ...
                <div className="relative z-10 hover:scale-105 transition-transform duration-500">
                  <Image
                    src="/images/banner/hero2.png"
                    alt="Starboard calendars and gift sets"
                    width={300}
                    height={300}
                    className="drop-shadow-xl w-[200px] sm:w-[250px] md:w-[300px] h-auto"
                  />
